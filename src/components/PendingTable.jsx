...
import { putUserAnalyst } from "../api/procedures";
...
export default function PendingTable({ headCells, rows }) {
	...
	const putUserMutation = useMutation((idProcedure) => {
		putUserAnalyst(idProcedure, currentUser.userId);
	});
										...
										<TableRow tabIndex={-1} key={index}>
											...
											<TableCell padding='normal' align='right'>
												<Button
													...
													disabled={currentUser.idMunicipalRole === 2}
												>
													Evaluar
												</Button>
											</TableCell>
