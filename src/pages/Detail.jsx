...
const DetailPage = () => {
	...
	const {
		...
		isError: isErrorInUsersResponsible,
	...
	if (isLoadingProcedureDetail || isLoadingUsers) return <Loader />;

	if (isError) return <ErrorAlert message={error.message} />;

	if (isErrorInUsersResponsible)
		return <ErrorAlert message={errorResponsible.message} />;
